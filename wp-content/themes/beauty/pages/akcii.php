...
<head>
   ...
   <title>Beauty&commat; &mdash; Акції та знижки</title>
</head>
<body>
   <!--header block-->
         ...
         <div class="container">
            <div class="header__menu--row">
               <ul class="nav__menu">
                  ...
                  <li class="nav__menu--item">
                     <a href="akcii.html" class="nav__menu--link active">Акції та знижки</a>
                  </li>
               </ul><!--/.-->
         ...
         <div class="container">
            <div class="promotion__row">
               ...
               <div class="promotion__row--content">
                  <p>
                     Ласкаво просимо до нашого інтернет-магазину, де кожен клієнт - це наша 
                     найбільша цінність! Кожен клієнт заслуговує на особливе увагу та виняткові 
                     пропозиції, тому пропонуємо вам не лише якісний товар, але й надзвичайні умови покупок.
                  </p>
                  <p>
                     На цій сторінці ви знайдете трошки інформації про наші акції та пропозиції. 
                     Ми завжди піклуємося про ваші потреби та бажання, тому пропонуємо регулярні 
                     сезонні знижки на весь асортимент. Не пропустіть шанс скористатися вигідними 
                     пропозиціями та придбати свої улюблені товари за вигідними цінами!
                  </p>
                  <p>
                     Але це ще не все! Ми віддячимо нашим постійним клієнтам за їх вірність та довіру. 
                     Кожен покупець отримує можливість отримати бонуси та додаткові переваги при кожній покупці.
                  </p>
                  <p>
                     Ми завжди раді бачити вас у нашому магазині та дарувати вам приємні знижки та 
                     подарунки.
                     Переконайтеся, що завітаєте до нас знову та знову, адже тут вас 
                     чекає не лише якісний сервіс, але й особлива увага до кожного клієнта. 
                  </p>
                  <p>
                     <span>
                  ...
                  <p>
                     <span>
                        *Послуга доставки по Україні компанією «Нова Пошта» до відділення Нової пошти 
                        безкоштовно при замовлення та 100% оплаті на суму від 2000 грн.
                     </span>
                  </p>
                  <p>
                     <span>
                        Купуй та оплачуй товар  одним чеком на суму від 2500 грн. та отримуй 
                        подарунок 🎁на суму від 250 грн.
                     </span>
                  </p>
               </div><!--/.content-->
            </div><!--/.promotion__row-->
